                ...
                <div>
                    ...
                    <div class="d-lg-flex align-items-center justify-content-between">
                        <div class="text-center mb-5 mb-lg-0">
                            <img class="img-fluid" src="{{asset('website/img/150x32/img1.png')}}" alt="Image-Description">
                        </div>
                        <div class="text-center mb-5 mb-lg-0">
                            <img class="img-fluid" src="{{asset('website/img/150x32/img2.png')}}" alt="Image-Description">
                        </div>
                        <div class="text-center mb-5 mb-lg-0">
                            <img class="img-fluid" src="{{asset('website/img/150x32/img3.png')}}" alt="Image-Description">
                        </div>
                        <div class="text-center mb-5 mb-lg-0">
                            <img class="img-fluid" src="{{asset('website/img/150x32/img4.png')}}" alt="Image-Description">
                        </div>
                        <div class="text-center mb-5 mb-lg-0">
                            <img class="img-fluid" src="{{asset('website/img/150x32/img5.png')}}" alt="Image-Description">
                        </div>
                        <div class="text-center mb-5 mb-lg-0">
                            <img class="img-fluid" src="{{asset('website/img/150x32/img6.png')}}" alt="Image-Description">
                        </div>
                    </div>
                </div>
            </div>
