                    ...
                    <div class="col-lg-9 mx-auto">
                        <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-4">
                            <div class="mb-4 mb-lg-7 ml-xl-4">
                                ...
                                <p class="font-weight-medium font-italic">دأبت دارُ السّمان منذ نشأتها على تحقيقِ كتبُ التراث الإسلامي و العربي، خدمةً لميراثِ علماءَ عظامَ قَضَو أيامَهم ولياليَهم في خدمةِ العلمِ و تدوينه، وسعياً لهذا الهدفِ الجليل:</p>
                                ...
                                <p class="font-weight-medium font-italic">يبدأ العمل في أي كتاب بدراسة القيمة العلمية له ومدى الحاجة إليه، ثم دراسة المخطوطات المتوفرة عنه ومدى صلاحيتها، متبعين في ذلك اموراً معيارية أهمها: صحة النسبة للمؤلف، وزمان النسخ، وتمام المخطوط، فتنسخ أجود النسخ المعتمدة وتقابل على الباقي مع إثبات الفروق في الحاشية، ثم مرحلة الضبط بالشكل، وتكون اعتماداً على علوم النحو والصرف بحيث لاتترك مجالاً للشك أو الغموض مع شرح الكلمات الغريبة بالرجوع إلى المعاجم الخاصة، ثم مرحلة تخريج الأحاديث والآثار والأشعار وعزوها الى الكتب المعتمدة في كل فن من هذه الفنون، مع ترجمة الأعلام ترجمةً مختصرةً وافيةً بما يخدم موضوع الكتاب، ثم مرحلة الإخراج الفني، وتوكل هذه المهمة إلى فريقٍ متخصصٍ محترفٍ في ذلك.</p>
                                <p class="font-weight-medium font-italic">وشأن أي دارٍ تحترم قراءها، تحرص دار السمّان على مرحلة قراءة الكتاب قراءةَ تدقيقٍِ أخير لاستدراك الهفوات، ليخرج الكتاب منقحاً منسقاً مفيداً للقارئ الكريم.</p>
