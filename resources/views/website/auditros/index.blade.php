                ...
                <div class="container">
                    <div class="u-cubeportfolio mb-5 mb-lg-7">
                        ...
                        <ul id="filterControls" class="d-flex justify-content-between list-inline cbp-l-filters-alignRight cbp-l-filters-alignRight__custom text-left pl-lg-8 pt-4 pt-lg-8 mb-5 mb-lg-8 overflow-auto">
                            <li class="list-inline-item bg-white text-secondary-gray-700 px-2 px-md-0 font-size-2 border-0 cbp-filter-item m-0 u-cubeportfolio__item cbp-filter-item-active" data-filter="*">All</li>
                        ...
                        <!-- Content -->
                        <div class="cbp cbp-caption-active cbp-caption-overlayBottomAlong cbp-ready" data-layout="grid" data-controls="#filterControls" data-animation="quicksand" data-x-gap="20" data-y-gap="100" data-media-queries="[
                            {&quot;width&quot;: 1100, &quot;cols&quot;: 5},
                            {&quot;width&quot;: 800, &quot;cols&quot;: 3},
                            {&quot;width&quot;: 480, &quot;cols&quot;: 1}
                          ]" style="height: 937px;"><div class="cbp-wrapper-outer"><div class="cbp-wrapper">
                                    <!-- Item -->
                                    <div class="cbp-item graphic" style="width: 200px; left: 0px; top: 0px;"><div class="cbp-item-wrapper">
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item branding" style="width: 200px; left: 300px; top: 0px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item branding" style="width: 200px; left: 600px; top: 0px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item branding" style="width: 200px; left: 900px; top: 0px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item branding" style="width: 200px; left: 1200px; top: 0px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item abstract graphic" style="width: 200px; left: 0px; top: 319px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Barbara O'Neal</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item abstract graphic" style="width: 200px; left: 300px; top: 319px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Stephen King</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item abstract graphic" style="width: 200px; left: 600px; top: 319px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">David Williams</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item abstract graphic" style="width: 200px; left: 900px; top: 319px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Joe Wicks</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item illustration abstract" style="width: 200px; left: 1200px; top: 319px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Jessica Simpson</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item illustration branding" style="width: 200px; left: 0px; top: 638px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Barbara O'Neal</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item illustration branding" style="width: 200px; left: 300px; top: 638px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Stephen King</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item illustration branding" style="width: 200px; left: 600px; top: 638px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">David Williams</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item illustration branding" style="width: 200px; left: 900px; top: 638px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Joe Wicks</h4>
                                    ...
                                    <!-- Item -->
                                    <div class="cbp-item illustration branding" style="width: 200px; left: 1200px; top: 638px;"><div class="cbp-item-wrapper">
                                            <a class="cbp-caption" href="../others/authors-single.html">
                                                <img class="rounded-circle img-fluid mb-3" src="https://placehold.it/140x140" alt="Image Description">
                                                <div class="py-3 text-center">
                                                    <h4 class="h6 text-dark">Jessica Simpson</h4>
