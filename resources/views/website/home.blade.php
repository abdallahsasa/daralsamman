                            ...
                            <div
                                ...
                                <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                    <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                            href="../shop/single-product-v1.html">{{$product->category->name}}</a></div>
                                    <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                        <a href="../shop/single-product-v1.html">{{$product->name}}</a></h2>
                                    <div class="font-size-2  mb-1 text-truncate">
                                        @foreach($product->author as $author)
                                        <a href="../others/authors-single.html" class="text-gray-700">{{$author->first_name}} {{$author->middle_name}} {{$author->last_name}}</a>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="banner__body">
                                    <div class="banner__image pb-1 mb-5">
                                        <img class="img-fluid" src="../../assets/img/350x282/img1.png"
                                    ...
                                    <h3 class="banner_text m-0">
                                        ...
                                        <span
                                            class="d-block mb-5 text-uppercase font-size-7 font-weight-regular text-gray-400">On Order Over $100</span>
                                    </h3>
                                        ...
                                        <div
                                            ...
                                            <div class="woocommerce-loop-product__thumbnail">
                                                <a href="../shop/single-product-v1.html" class="d-block"><img
                                                        src="../../assets/img/120x180/img10.jpg"
                                                        class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                            ...
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                ...
                                                <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                    <a href="../shop/single-product-v1.html">Think Like a Monk: Train
                                        ...
                                        <div
                                            ...
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                                        href="../shop/single-product-v1.html">Paperback</a></div>
                                                <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                    <a href="../shop/single-product-v1.html">Man's Search for
                                                        Meaning</a></h2>
                                                <div class="font-size-2  mb-1 text-truncate"><a
                                                        href="../others/authors-single.html" class="text-gray-700">Jay
                                                        Shetty</a></div>
                                        ...
                                        <div
                                            ...
                                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                                <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                                        href="../shop/single-product-v1.html">Paperback</a></div>
                                                <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                                    <a href="../shop/single-product-v1.html">Blindside (Michael
                                                        Bennett)</a></h2>
                                                <div class="font-size-2  mb-1 text-truncate"><a
                                                        href="../others/authors-single.html" class="text-gray-700">Jay
                                                        Shetty</a></div>
                ...
                <div class="col-md-7 col-lg-8 col-xl-9">
                    <div class="mx-lg-8 mx-wd-4">
                        <div class="js-slick-carousel products no-gutters slick-initialized slick-slider slick-dotted"
                            ...
                            <div
                                class="js-prev d-none d-lg-block u-slick__arrow u-slick__arrow-centered--y rounded-circle fas fa-chevron-left u-slick__arrow-inner u-slick__arrow-inner--left ml-lg-n8 ml-wd-n4 slick-arrow slick-disabled"
                            ...
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                    ...
                                    <div
                                        ...
                                        data-slick-index="0" aria-hidden="false" style="width: 249px; height: auto;"
                                        tabindex="0" role="tabpanel" id="slick-slide50"
                                    ...
                                    <div class="product product__no-border border-right slick-slide slick-active"
                                         data-slick-index="1" aria-hidden="false" style="width: 249px; height: auto;"
                                         tabindex="0" role="tabpanel" id="slick-slide51"
                                    ...
                                    <div class="product product__no-border border-right slick-slide"
                                         data-slick-index="4" aria-hidden="true" style="width: 249px; height: auto;"
                                         tabindex="-1" role="tabpanel" id="slick-slide54"
                                        ...
                                        <div class="product__inner overflow-hidden px-3 px-md-4d875">
                                            <div
                                                ...
                                                <div class="woocommerce-loop-product__thumbnail">
                                                    <a href="../shop/single-product-v2.html" class="d-block"
                                                       tabindex="-1"><img src="../../assets/img/120x180/img5.jpg"
                                                                          class="d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid"
                                                                          alt="image-description"></a>
                                                </div>
                                                <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                    ...
                                    <div class="product product__no-border border-right slick-slide"
                                         data-slick-index="5" aria-hidden="true" style="width: 249px; height: auto;"
                                         tabindex="-1" role="tabpanel" id="slick-slide55"
