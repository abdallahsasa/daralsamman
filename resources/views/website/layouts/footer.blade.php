...
{{--                        @foreach($footerCategories as $category)--}}
                        <li class="pb-2"><a class="font-size-2 text-white widgets-hover transition-3d-hover" href="{{route('website.products.category.index',20)}}">الفقه وعلومه</a></li>
                        <li class="pb-2"><a class="font-size-2 text-white widgets-hover transition-3d-hover" href="{{route('website.products.category.index',14)}}">النحو واللغة</a></li>
                        <li class="pb-2"><a class="font-size-2 text-white widgets-hover transition-3d-hover" href="{{route('website.products.category.index',18)}}">الحديث وعلومه</a></li>
                        <li class="pb-2"><a class="font-size-2 text-white widgets-hover transition-3d-hover" href="{{route('website.products.category.index',12)}}">التزكية والرقائق</a></li>
{{--                        @endforeach--}}
